...
export default async function NearestMarketsPage({
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-4">
                ...
                <p className="text-sm font-medium text-muted-foreground animate-pulse">
                    Select a commodity above to find local mandis prioritized by
                    proximity to your district.
                </p>
            </div>
        );
    }
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-4">
                ...
                <div className="p-4 rounded-lg bg-destructive/10 border border-destructive/20 text-destructive text-sm font-medium flex items-center gap-2">
                    ...
                    <span>
                        Commodity &ldquo;{params.commodity}&rdquo; not found.
                        Please try searching for another crop.
                    </span>
                </div>
            </div>
        );
    ...
    let sortedMarkets, total;

    if (data) {
        sortedMarkets = data.sortedMarkets;
        total = data.total;
    }
        ...
        <div className="space-y-8 pb-10 max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-col items-center justify-center space-y-2 text-center pt-2">
                ...
                <p className="text-xs sm:text-sm text-muted-foreground max-w-2xl font-mono">
                    Locate mandi prices for your crop. Markets matching your
                    local district are automatically prioritized at the top.
                </p>
            </div>
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground font-mono">
                            Markets in your district are highlighted and listed
                            first, sorted by modal price.
                        </p>
                    </div>
                </div>
